Rails.application.config.middleware.use OmniAuth::Builder do
  provider :github, Rails.application.credentials[:GITHUB_KEY], Rails.application.credentials[:GITHUB_SECRET], scope: 'user:email', redirect_uri: 'http://localhost:3000/auth/github/callback'
